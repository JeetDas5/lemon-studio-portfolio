    ...
    <footer className="w-full bg-[#1b2316] text-white pt-24 pb-16 px-8 md:px-16 border-t border-white/5">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
        ...
        <div className="flex flex-col justify-between">
          ...
          {/* Social Links */}
          <div className="flex items-center gap-8 mt-16 font-bold tracking-widest text-white text-[16px] font-sans">
        ...
        <div className="flex flex-col">
          ...
          <ul className="space-y-4 font-sans text-white/70 font-light text-[16px]">
        ...
        {/* Column 3: Subscription & Copyright */}
        <div className="flex flex-col justify-between items-start md:items-end">
          <div className="w-full max-w-[420px] md:text-right">
            ...
            <div className="flex items-center border border-white/20 rounded-2xl p-1 w-full bg-transparent focus-within:border-white/40 transition-colors duration-300 mt-6">
              <input
                ...
                className="bg-transparent border-none outline-none text-white placeholder-white/35 px-4 py-2.5 flex-1 text-[16px] w-full font-sans"
              />
          ...
          {/* Copyright text */}
          <div className="text-white/50 text-[15px] font-sans tracking-wide mt-20 w-full text-left md:text-right">
